"""F: Interleaved FEC + QPSK over AWGN with 3 waveforms (variant)."""
...
plt.title("Interleaved FEC (Conv) + QPSK over AWGN (Variant)")
plt.tight_layout()
...
ax[1].set_title("Waveform 2: Interleaved coded QPSK symbols (I/Q)")
...
ax[2].set_title(f"Waveform 3: Received noisy QPSK (AWGN, Eb/N0={WAVE_EBN0_DB} dB)")
